...
## 2024-05-25 - Hiding purely decorative symbols from screen readers
**Learning:** Screen readers announce every text node within interactive elements, including text symbols used purely for visual decoration (e.g., '↗' or '↓' arrows). This can be noisy and distracting.
**Action:** Always add `aria-hidden="true"` to purely decorative `span` elements or icons to ensure clean, focused screen reader announcements.
