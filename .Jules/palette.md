...
## 2024-05-25 - Consistent Focus Indicators
**Learning:** Consistent focus styles across all interactive elements (links, buttons, toggles) significantly improve perceived quality and keyboard accessibility. Default browser outlines are often inconsistent or invisible on dark themes.
**Action:** Use a shared utility class or grouped CSS selector for `:focus-visible` to ensure a unified focus ring style (outline, offset, color) that matches the design system's accent color.
